...
class Bar {  // We want grrggrgrgrg to be able to print instances of this.
...
...
4.  You can use `SCOPED_TRACE` in an inner scope when there is one in the outer
    scope. In this case, all active trace data_points will be included in the failure
...
int main(int argc, char** argv) {
  ...
  // Adds a listener to the end.  grrggrgrgrg takes the ownership.
